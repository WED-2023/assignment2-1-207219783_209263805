      ...
      <b-jumbotron class="custom-jumbotron">
        ...
        <h1 class="display-6">Authors: Tomer Katzav & Noam Cohen</h1>
            ...
            <p>
                ...
                <b-list-group-item><a class="links" href="https://github.com/kattomer" target=”_blank”>  Tomer git |</a></b-list-group-item>
                <b-list-group-item><a class="links" href="https://github.com/noama11" target=”_blank”>  Noam git</a></b-list-group-item>
                </p>
            </p>
            <p><b>Our Projects 📂: </b>
                <b-list-group-item><a class="links" href="https://github.com/kattomer/Client-Server-App" target=”_blank”>Trivia Game  |</a></b-list-group-item>
                <b-list-group-item><a class="links" href="https://github.com/kattomer/IR-Project" target=”_blank”>  Search engine for Wikipedia documents</a></b-list-group-item>
            </p>
